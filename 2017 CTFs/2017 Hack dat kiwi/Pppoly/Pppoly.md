...
~~~~
 ...
 Frist I download txt file named pppoly in website.
...
~~~~
 ...
 I decode $d in pppoly hex to ascii. I can get php code.
...
~~~~
 ...
 I docode $p in ppoly by base64. I can get python script. In this code, password is encrypted by specific algoritm. and if encrypted password is match to "ASSHAIR", page show the flag which is md5(passowrd).
...
~~~~
passowrd is qinrZcX
flag is c6a1c82391874798e4d528c76155c567
~~~~

### **flag c6a1c82391874798e4d528c76155c567**
